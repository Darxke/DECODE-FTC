...
public final class PinpointLocalizer implements Localizer {
    public static class Params {
        public double parYTicks = 229.06535756143944; // y position of the parallel encoder (in tick units)
        public double perpXTicks = -4060.940186734997; // x position of the perpendicular encoder (in tick units)
    }
